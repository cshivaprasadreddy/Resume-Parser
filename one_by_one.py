...
@app.route("/")
def index():
    return render_template("index_onebyone.html")
...
def process():
    ...
    headers = {
        "Authorization": "Bearer weyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1c2VyX2lkIjoiYjM1ZGYxZGYtMzc4Ny00NDY3LWFlNWEtYzFjYjJkODU0MWU5IiwidHlwZSI6ImFwaV90b2tlbiJ9.cDnAxB_SI-aLqpm6HqHKBHmzq5BJ91yqpzuhVOzs6fo"
    }
